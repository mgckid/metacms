...
<div class="layui-container">
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form class="layui-form" action="{:url('admin/login/index')}" method="post">
                ...
                <!--<div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" src="/static/admin/layuimini/images/captcha.jpg">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script src="/static/admin/layuimini/lib/jq-module/jquery.particleground.min.js" charset="utf-8"></script>
<script>
