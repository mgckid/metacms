...
<head>
    ...
    <![endif]-->
    <style>
        body {background-image:url("/static/admin/layuimini/images/bg.jpg");height:100%;width:100%;}
...
<div id="container">
    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form" action="{:url('admin/login/index')}">
            <div>
            ...
            <div>
                ...
                <img class="admin-captcha" width="90" height="30" src="/static/admin/layuimini/images/captcha.jpg">
            </div>
