...
<link href="http://static.furong.me/admin/js/bootstrap-fileinput-master/css/fileinput.css" media="all" rel="stylesheet"
      type="text/css"/>
<!-- if using RTL (Right-To-Left) orientation, load the RTL CSS file after fileinput.css by uncommenting below -->
<!-- link href="http://static.furong.me/admin/js/bootstrap-fileinput-master/css/fileinput-rtl.min.css" media="all" rel="stylesheet" type="text/css" /-->
...
<script src="http://static.furong.me/admin/js/bootstrap-fileinput-master/js/plugins/piexif.min.js" type="text/javascript"></script>
<!-- sortable.min.js is only needed if you wish to sort / rearrange files in initial preview.
    This must be loaded before fileinput.min.js -->
<script src="http://static.furong.me/admin/js/bootstrap-fileinput-master/js/plugins/sortable.min.js" type="text/javascript"></script>
<!-- purify.min.js is only needed if you wish to purify HTML content in your preview for
    HTML files. This must be loaded before fileinput.min.js -->
<script src="http://static.furong.me/admin/js/bootstrap-fileinput-master/js/plugins/purify.min.js" type="text/javascript"></script>
...
<script src="http://static.furong.me/admin/js/bootstrap-fileinput-master/js/fileinput.min.js"></script>
<!-- optionally uncomment line below for loading your theme assets for a theme like Font Awesome (`fa`) -->
<!-- script src="http://static.furong.me/admin/js/bootstrap-fileinput-master/themes/fa/theme.min.js"></script -->
<!-- optionally if you need translation for your language then include  locale file as mentioned below -->
<script src="http://static.furong.me/admin/js/bootstrap-fileinput-master/js/locales/zh.js"></script>
<script src="http://static.furong.me/admin/js/bootstrap-fileinput-master/themes/fa/theme.js"></script>
